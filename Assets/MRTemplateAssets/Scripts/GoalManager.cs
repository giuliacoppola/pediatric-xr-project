...
namespace UnityEngine.XR.Templates.MR
{
    ...
    public class GoalManager : MonoBehaviour
    {
        ...
        [SerializeField, Tooltip("Se attivo, la scena parte gia in passthrough (extended reality) invece che con lo skybox virtuale. Utile per scene come il menu di scelta pianeta.")]
        bool m_StartInPassthrough = false;

        [SerializeField, Tooltip("Se attivo, salta l'onboarding di scansione superfici (Coaching UI) e va dritto alla scena.")]
        bool m_SkipOnboarding = false;
        ...
        void Start()
        {
            ...
            if (m_FeatureController != null)
                m_FeatureController.TogglePassthrough(m_StartInPassthrough);
            ...
            // Salta l'onboarding (scansione superfici) senza toccare le altre scene.
            // Nasconde la Coaching UI e ferma la sequenza di goal, mantenendo lo stato
            // di passthrough scelto sopra (m_StartInPassthrough).
            if (m_SkipOnboarding)
            {
